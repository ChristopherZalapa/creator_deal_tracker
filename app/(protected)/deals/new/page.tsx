				...
				<div className='space-y-1.5'>
					...
					<div className='relative'>
						<select
							name='creator_id'
							required
							className='w-full h-9 appearance-none rounded-md border border-white/10 bg-[#0d0d0d] px-3 pr-8 mt-1 py-1 text-sm text-white focus:outline-none focus:ring-1 focus:ring-white/30 transition-colors cursor-pointer'
						>
